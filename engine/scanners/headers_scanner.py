    ...
    def run(self) -> None:
            ...
            if value is None:
                if header_config["required"]:
                    ...
                    self.add_finding(
                        ...
                        remediation=f"Adicione o header '{header_name}' nas respostas do servidor. Consulte: https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/{header_name}",
                        owasp_category="A05:2021 - Security Misconfiguration",
                    ...
                    self.add_finding(
                        ...
                        remediation=f"Considere adicionar o header '{header_name}' para maior seguranca.",
                        owasp_category="A05:2021 - Security Misconfiguration",
                        affected_url=self.base_url,
                    )
            else:
                ...
                if expected and value.lower() != expected.lower():
                    self.add_finding(
                        ...
                        remediation=f"Configure o header '{header_name}' com o valor '{expected}'.",
                        owasp_category="A05:2021 - Security Misconfiguration",
                        cvss_score=2.0,
                        affected_url=self.base_url,
                    )
        ...
        if server_header:
            self.add_finding(
                ...
                remediation="Remova ou ofusque o header 'Server' na configuracao do seu web server.",
                owasp_category="A05:2021 - Security Misconfiguration",
                cvss_score=2.0,
                affected_url=self.base_url,
            )
        ...
        if x_powered:
            self.add_finding(
                ...
                remediation="Remova o header 'X-Powered-By'. No Express.js use app.disable('x-powered-by').",
                owasp_category="A05:2021 - Security Misconfiguration",
                cvss_score=2.0,
                affected_url=self.base_url,
            )
